...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = KEYMAP(KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, TT(3),
		...
		KC_LGUI, KC_LGUI, LSFT(KC_3), TD(L_PRNS), KC_SPC, KC_BSPC, TD(R_PRNS), LSFT(KC_1), KC_BSLS, KC_LALT),
...
//LED Controls (plus setting/resetting is_layer_2 for use with Tap Dance)
...
qk_tap_dance_action_t tap_dance_actions[] = {
  [L_PRNS] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, lp_func, NULL, 350),
  [R_PRNS] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, rp_func, NULL, 350),
  [VOL_BRI_DN] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, vbd_func, NULL, 350),
  [VOL_BRI_UP] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, vbu_func, NULL, 350),
  [FF_NAV_LFT] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, fnl_func, NULL, 350),
  [FF_NAV_RGT] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, fnr_func, NULL, 350),
